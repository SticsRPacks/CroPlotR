...
test_that("Ellipsis is working",{
  ...
  plot <- create_plot(df, "x", "y", mapping=ggplot2::aes(color=c, shape=s))
...
test_that("Ellipsis priority is working",{
  ...
  expect_warning(plot <- create_plot(df, "x", "y", mapping=ggplot2::aes(color=c1, shape=s),
...
test_that("Gestion of units is working",{
  ...
  plot <- create_plot(df, "x", "y", mapping=ggplot2::aes(color=as.factor(c1)))
