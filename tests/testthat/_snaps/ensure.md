    ...
    Output
      List of 3
       $ object :List of 3
        ...
        .. ..$ thickness       : int [1:28] 200 115 80 180 120 120 100 60 120 120 ...
        .. ..$ soil_max_wtr_cap: Units: [cm^2*mm/g] num [1:28] 321.4 194.6 79.5 263.6 173 ...
        ...
        .. ..$ layer_max_wtr_cap     : Units: [cm^2*mm/g] num [1:140] 44.5 41.4 39.6 48.7 48.7 ...
        ..$ dict        :List of 6
        .. ..$ id                    : chr "name"
...
# ensure_wrapper function failed
    ...
    Graph type `thickness.mswc.norg` requires the following parameters:
      `thickness`
    	OR  `layer_thickness`
      AND `soil_max_wtr_cap`
    	OR  `layer_max_wtr_cap`
    		OR  `layer_thickness`
    		AND `layer_bulk_density`
...
# ensure_layer_max_wtr_cap

    Code
      ensure_layer_max_wtr_cap(soil)
    Output
      $object
      $object$data
...
# ensure_soil_max_wtr_cap

    Code
      ensure_soil_max_wtr_cap(soil)
    Output
      $object
      $object$data
        id soil_max_wtr_cap
