...
weather <- set_weather(weather_data_list, station_name = "station", temp_day_max = list("ttmax", "celsius"),
                       temp_day_min = list("ttmin", "celsius"), year = "year",rainfall_day = list("ttrr", "mm"))
...
weather_without_temp_day_max <- set_weather(weather_data_list, station_name = "station", temp_day_min = list("ttmin", "celsius"), year = "year",rainfall_day = list("ttrr", "mm"))
...
weather_without_temp_day_min <- set_weather(weather_data_list, station_name = "station", temp_day_max = list("ttmax", "celsius"),year = "year",rainfall_day = list("ttrr", "mm"))
test_that("plot type all warns in case verbose is true and not all graphs can be plotted",{
...
weather_without_rainfall <- set_weather(weather_data_list, station_name = "station", temp_day_min = list("ttmin", "celsius"), temp_day_max = list("ttmax", "celsius"), year = "year")
...
weather_without_temp <- set_weather(weather_data_list, station_name = "station", year = "year",rainfall_day = list("ttrr", "mm"))
