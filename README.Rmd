...
> #2](https://github.com/SticsRPacks/CroPlotR/issues/2)). If you want to
> do so, you are encouraged to scale before the plotting function, and
> to add a second axis using
...
[`summary.stics_simulation()`](https://sticsrpacks.github.io/CroPlotR/reference/summary.cropr_simulation.html)
and
