---
title: "Preaparing your data for plotting"
...
Every source of data (eg. soil, weather, ...) has its own such function that takes into account specificities of the data origin. Concrete examples for how these function are used with real input data for the STICS and DSSAT crop models can be found in [Examples for loading data: STICS and DSSAT](set_data_examples.html). More explanation on how to use the resulting data objects in plots function can be found in [Using the plot functions](plot_data.html).
