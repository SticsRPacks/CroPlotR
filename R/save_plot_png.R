...
#' @param units  The units for plot width and heigth in
#' `units ("in", "cm", or "mm")`
#' @param dpi    The plot resolution.
#' @param scale  The scaling factor.
#' @param device Device to use. Can either be a device function (e.g. png()),
...
#' @return Save the plots to `path`, named by the situation name,
#' and returns the plots invisibly for piping.
#' @export
#'
save_plot_png <- function(plot, out_dir, suffix = "", width = 17, height = 12,
