...
All the plot functions work in exactly the same way. This vignette will use the `plot_soil` function as an example to illustrate the plot functions' different functionalities.
