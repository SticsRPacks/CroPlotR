...
## Introduction
The vignette *preparing data for plotting* shows how you can load your own data into a `cropr_input` object. This vignette shows how this object can then be used to create plots. Let's load some example data objects
```{r, message=FALSE}
library(CroPlotR)
